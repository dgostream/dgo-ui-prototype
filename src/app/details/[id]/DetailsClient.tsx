      ...
      <main className="min-h-screen bg-black">
         ...
         <nav className="fixed top-0 left-0 right-0 z-50 p-8 max-md:p-4 flex items-center justify-between pointer-events-none">
            ...
            <div className="flex items-center">
               <img src={publicUrl("/dgo-logo-new.png")} alt="DGO" className="h-8 max-md:h-5 w-auto object-contain opacity-40 grayscale" />
            </div>
         </nav>
            ...
            <div className="absolute inset-0 -z-10">
               ...
               {content.detailsHeroImg || content.heroImg || content.img ? (
                  ...
                  <div className="w-full h-full bg-brand-secondary flex items-center justify-center">
                     <img src={publicUrl("/ios-icon.png")} alt="DGO" className="w-1/5 h-auto object-contain opacity-[0.06]" />
                  </div>
               )}
               <motion.div
                  initial={{ opacity: 0 }}
               ...
               >
                  <img src={publicUrl("/dgo-logo-new.png")} alt="DGO" className="w-[40vw] h-auto object-contain opacity-20 grayscale brightness-0 invert" />
               </motion.div>
            </div>
                     ...
                     >
                        <div className="w-48 h-28 max-md:w-32 max-md:h-20 bg-[#111] rounded-2xl shrink-0 relative overflow-hidden flex items-center justify-center">
                           {ep.thumbnail ? (
                              ...
                              <img src={publicUrl("/ios-icon.png")} alt="DGO" className="w-8 h-8 object-contain opacity-[0.1]" />
                           )}
