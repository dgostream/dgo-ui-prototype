                ...
                >
                  ...
                  {content.img ? (
                    ...
                    <div className="absolute inset-0 bg-brand-secondary flex items-center justify-center">
                      <img src={publicUrl("/ios-icon.png")} alt="DGO" className="w-2/5 h-auto object-contain opacity-[0.07]" />
                    </div>
                  )}
                    ...
                    <div className={cn(portrait ? "space-y-4" : "space-y-6")}>
                      <div className="space-y-1">
                        <div className="flex items-center gap-4">
                          ...
                          <img src={publicUrl("/dgo-logo-new.png")} alt="DGO" className="h-4 w-auto object-contain brightness-0 invert opacity-60" />
